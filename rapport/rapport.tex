...
\begin{figure}[H]
\includegraphics[scale=0.42]{ressources/block2}\includegraphics[scale=0.42]{ressources/block3}\includegraphics[scale=0.42]{ressources/block4}\caption{Différents labyrinthes disponibles}
